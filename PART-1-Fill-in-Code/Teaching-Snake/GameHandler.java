...
public class GameHandler {
    ...
    public Coordinate[][] getBoard(){
        /* FILL IN CODE NEEDED */
        return null; //Temporary Fix for Compiling
    }//GetBoard
    ...
    public void moveUp(){
        ...
        /* FILL IN CODE NEEDED */
        //Will want to use handleCollision(...) here
    ...
    public void randomlyPlaceBlock(){
        ...
        boolean isNotFreeSlot = false; //Should be true. 
        while (isNotFreeSlot){
            /* FILL IN CODE NEEDED */
            // Will need to check if empty slot before placing new target
            // Will want to use Random here
        }//While Loop
    }//randomlyPlaceBlock
    ...
    /**
     * Will search through 2d array Board and look for a matching type of 'searchItem'.
    ...
    public ArrayList<Coordinate> findCoordinatesOf(Coordinate searchItem) {
        ...
        /* FILL IN CODE NEEDED */
        // Will want to use Coordinates equals method
        // When you find an equal coordinate, use: listOfSearched.add(...) to add to the array list
